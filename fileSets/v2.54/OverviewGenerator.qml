// GENERATOR CONNECTOR
// This file has been automatically modified to show 
...
// GENERATOR CONNECTOR - added the following line
    property VBusItem externalOveride: VBusItem { bind: Utils.path(bindPrefix, "/ExternalOverride") }
...
// GENERATOR CONNECTOR - added the following lines
        values: [
                // spacer
                TileText {
...
// GENERATOR CONNECTOR - added the following lines
            ...
            TileTextMultiLine {
                text: qsTr("External Override Generator is\nNOT running");
                width: statusTile.width - 5
                color: "yellow"
                visible: externalOveride.valid ? externalOveride.value : false
// GENERATOR CONNECTOR - end add
			}
		]
	}
